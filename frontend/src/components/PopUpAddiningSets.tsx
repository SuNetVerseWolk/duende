export default function PopUpAddingSets() {
    return(
        <div className="relative top-[-50] left-15 p-5 bg-black border-1 rounded-lg text-white">
            <input className="w-full px-4 py-2 mt-1 text-white bg-gray-700 border border-gray-600 rounded
                         focus:border-white focus:ring focus:ring-white focus:outline-none
                         transition-colors duration-300" type="text" placeholder="Название набора" />
            ...
            <button className="py-2 font-semibold text-white bg-blue-600 w-full
                       hover:bg-blue-700 transition-colors shadow-md
                       focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 duration-300 mt-4 rounded-sm">Добавить</button>
        </div>
    );
}