...
import { useMySets, useProfile, useUser } from "@/hooks/useAuth"; // Предполагается, что есть useAuth с logout
  ...
  return (
    <div className="flex justify-center min-h-screen bg-gradient-to-r from-black via-[#1f2834] to-black px-4">
      <div className="w-lg h-full">
        <form className="flex flex-row justify-center max-w-2xl mx-auto gap-3 sm:gap-4 bg-white/5 p-4 sm:p-5 md:p-6 rounded-2xl my-4 sm:my-5">
